...
export default function SlabsPage() {
  ...
  const slabData = importData?.slab?.columns || importData?.slab || [];
  const filteredData = slabData.filter((item: any) =>
        ...
        >
          ...
          <main className="flex-1 p-6 lg:p-8 space-y-6">
            ...
            <div className="flex items-center gap-2 text-xs text-zinc-400">
              ...
              <span>/</span>
              <span className="text-zinc-600">Slabs</span>
            </div>
